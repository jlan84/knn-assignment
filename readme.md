...
Play around with some more interesting data sets.  Run you tree algorithm on a beast cancer [data set](http://archive.ics.uci.edu/ml/datasets/Breast+Cancer+Wisconsin+%28Original%29) to predict malignant tumors.  You are essentially a doctor now.  Go into the world and heal.
